...
const layers = [
  { n: '05', t: 'Oberboden / Beschichtung', d: 'Vinyl, Parkett oder Epoxidharz.', c: '#6b4f2a', image: '/1.jpeg' },
  { n: '04', t: 'Estrichschicht', d: 'Zement- oder Anhydritestrich.', c: '#9a938a', image: '/2.jpeg' },
  { n: '03', t: 'Fußbodenheizung', d: 'Tacker, Noppen oder Schlüter-BECOTEC.', c: '#e0a11c', image: '/1.jpeg' },
  { n: '02', t: 'Wärmedämmung & Tackerplatte', d: 'Dämmung & Rolljet.', c: '#c9b48a', image: '/2.jpeg' },
  { n: '01', t: 'Abdichtung', d: 'Katja Sprint / Schweißbahn.', c: '#3c3831', image: '/1.jpeg' },
  { n: '00', t: 'Rohbetondecke (Bestand)', d: 'Der vorhandene Untergrund.', c: '#1c1a17', image: '/2.jpeg' },
]
