...
export default function Header() {
  ...
  const useDarkLogo = isSolid || narrow
    ...
    <header className={`nav ${isSolid ? 'nav--solid' : ''}`}>
      <div className="wrap nav__row">
        <Link to="/" className="nav__brand" aria-label="Kaymak Bau Startseite">
          <img className="nav__logo" src={`${base}${useDarkLogo ? 'logonew-dark.png' : 'logonew.png'}`} alt="Kaymak Bau" />
        </Link>
        ...
        <nav className={`nav__menu ${open ? 'open' : ''}`} aria-label="Hauptnavigation">
          ...
          <div className="nav__menu-contact">
            <a href="tel:+491632051432" className="nav__menu-contact-link">
              <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
              </svg>
              Anrufen
            </a>
            <a href="https://wa.me/491632051432" target="_blank" rel="noreferrer" className="nav__menu-contact-link">
        ...
        <div className="nav__contact">
          <a href="tel:+491632051432" aria-label="Anrufen">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
            </svg>
          </a>
          <a href="https://wa.me/491632051432" target="_blank" rel="noreferrer" aria-label="WhatsApp">
