...
export default function ReferenceDetail() {
  ...
  return (
    <>
      ...
      <section className="section"><div className="wrap"><img className="dhero__cover reveal" src={p.cover} alt={p.title} /></div></section>
                  ...
                  <button type="button" key={`${item.src}-${i}`} className="gallery__item" onClick={() => setActiveIndex(i)}>
                    {item.type === 'image' ? (
                      ...
                      <div className="gallery__videoWrap">
                        <video src={item.src} poster={item.poster || p.cover} preload="metadata" muted autoPlay loop playsInline />
