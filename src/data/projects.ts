...
export const projects: Project[] = [
  {
    ...
    gallery: [
      { type: 'image', src: `${base}asb.jpg`, alt: 'ASB Rettungswache Frankfurt Bild 1' },
  ...
  },
  {
    ...
    gallery: [
      { type: 'image', src: `${base}villa2.jpg`, alt: 'Villa Kennedy Referenzbild 1' },
      ...
      { type: 'image', src: `${base}villa6.png`, alt: 'Villa Kennedy Referenzbild 5' },
      { type: 'video', src: `${base}villavideo.mp4`, poster: `${base}villa2.jpg`, alt: 'Villa Kennedy Video' },
    ],
  },
  {
  ...
  },
  {
    ...
    cover: `${base}Mehrfamilienhaus2.png`,
    ...
    gallery: [
      { type: 'image', src: `${base}Mehrfamilienhaus2.png`, alt: 'Mehrfamilienhäuser Bild 1' },
      { type: 'image', src: `${base}Mehrfamilienhaus3.png`, alt: 'Mehrfamilienhäuser Bild 2' },
      { type: 'image', src: `${base}Mehrfamilienhaus4.png`, alt: 'Mehrfamilienhäuser Bild 3' },
      { type: 'image', src: `${base}Mehrfamilienhaus5.png`, alt: 'Mehrfamilienhäuser Bild 4' },
      { type: 'video', src: `${base}Mehrfamilienhaus.mp4`, poster: `${base}Mehrfamilienhaus2.png`, alt: 'Mehrfamilienhäuser Video' },
    ],
  },
  {
